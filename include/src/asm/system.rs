...
#[inline]
fn _set_gate(gate_addr: &mut desc_struct, type_: usize, dpl: usize, addr: usize) {
    unsafe {
...
#[inline]
pub fn set_intr_gate(n: usize, addr: usize) {
    unsafe { _set_gate(&mut idt[n], 14, 0, addr); }
}

#[inline]
pub fn set_trap_gate(n: usize, addr: usize) {
    unsafe { _set_gate(&mut idt[n], 15, 0, addr); }
}

#[inline]
pub fn set_system_gate(n: usize, addr: usize) {
    unsafe { _set_gate(&mut idt[n], 15, 3, addr); }
}
...
#[inline]
pub fn set_tss_desc(n: usize, addr: usize) { _set_tssldt_desc!(n, addr, "0x89"); }

#[inline]
pub fn set_ldt_desc(n: usize, addr: usize) { _set_tssldt_desc!(n, addr, "0x82"); }
